...
featuredImage: "/assets/needle-in-haystack.jpeg"
---
...
![A comparison of two ways to describe the same role on a CV: a vague list of tasks that leaves the reader asking "why?", versus a version framed around the company, the problem, and the outcome.](/assets/shiny.jpeg)
...
2. Emphasise things which demonstrate personal qualities that startups value, like determination, creativity, and ambition.
